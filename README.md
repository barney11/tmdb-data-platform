...
Curated data rendering is done with __Looker Studio__. The following looker studio report is updated when new curated data is available and __shows charts related to the 250 most popular movies that are currently in theatres.__ : 
